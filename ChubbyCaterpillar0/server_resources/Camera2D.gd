...
var scouting_distance_x := 0.16 # how far ahead camera looks in direction of velocity_x
var scouting_distance_y := 0.08 # how far ahead camera looks in direction of velocity_y
