...
func primary_fire(fire_transform: Transform, fire_parameters):
	...
	fire_audio_player.set_stream(load("res://arms/arms_assets/primary_fire.wav"))
...
func secondary_fire(fire_transform: Transform, fire_parameters):
	...
	fire_audio_player.set_stream(load("res://arms/arms_assets/shot.wav"))
	fire_audio_player.play()

func tertiary_fire(fire_transform: Transform, fire_parameters):
	fire_by_mode(2, fire_transform, fire_parameters)
	fire_audio_player.set_stream(load("res://arms/arms_assets/woosh.wav"))
...
func animate_fire(power: float):
	...
	if not clip_remaining == 0:
		...
		load_audio_player.set_stream(load("res://arms/arms_assets/shotgun_pump.wav"))
...
func animate_reload():
	...
	load_audio_player.set_stream(load("res://arms/arms_assets/Pushing-Magazine-Into-Gun-www.fesliyanstudios.com.wav"))
	load_audio_player.play()
